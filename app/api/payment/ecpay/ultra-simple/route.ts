    ...
    const ultraSimpleHtml = `
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>🚀 綠界超簡化測試</h1>
            <p style="color: #666; font-size: 1.2em;">最短訂單編號 + 正確 CheckMacValue</p>
          </div>
          
          <div class="alert alert-info">
            <strong>🎯 測試目標：</strong> 使用最短的訂單編號（15字元）避免長度限制錯誤
          </div>
          ...
          <div class="section">
            ...
            <div class="step">
              ...
              <br><strong>格式：</strong> T + 年月日時分秒 + 2位隨機數
            </div>
          </div>
          ...
          <div class="section">
            ...
            <form method="POST" action="${ECPAY_CONFIG.PAYMENT_URL}" target="_blank">
              ...
              <button type="submit" class="test-button">🚀 測試超簡化配置</button>
            </form>
          </div>
          ...
          <div class="alert alert-warning">
            <strong>⚠️ 重要提醒：</strong> 如果還是出現錯誤，請檢查綠界後台配置是否正確
          </div>
        </div>
      </body>
      </html>
