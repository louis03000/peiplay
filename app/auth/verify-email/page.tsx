          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative bg-white rounded-lg shadow-xl p-6 max-w-sm w-full mx-4 border border-gray-200">
              ...
              <p className="text-gray-600 text-sm mb-4 text-center">
                為了進行陪玩、語音服務與即時通知，<br />
                請依照以下步驟加入我們的 Discord 伺服器。
              </p>

              {/* 步驟教學 */}
              <div className="bg-gray-50 rounded-lg p-4 space-y-3 mb-4 border border-gray-200">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-700 text-sm flex-1">先打開 Discord App</p>
                </div>
                <div className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#5865F2] text-white text-xs font-bold flex items-center justify-center">②</span>
                  <p className="text-gray-700 text-sm flex-1">左側點「＋」</p>
                </div>
                <div className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#5865F2] text-white text-xs font-bold flex items-center justify-center">③</span>
                  <p className="text-gray-700 text-sm flex-1">選擇「加入伺服器」</p>
                </div>
                <div className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#5865F2] text-white text-xs font-bold flex items-center justify-center">④</span>
