...
export default function PartnerProfilePage() {
  ...
  }, [showImageModal, displayImages.length, handlePrevImage, handleNextImage])
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900">
      ...
      <div className="relative max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="bg-gray-800/90 backdrop-blur rounded-2xl shadow-2xl overflow-hidden">
          ...
          {displayImages.length > 0 && (
            <div 
              className="relative w-full h-96 md:h-[500px] lg:h-[600px] bg-gray-900 cursor-pointer"
            ...
            >
              ...
              {/* 點擊放大提示 */}
              <div className="absolute top-4 left-4 bg-black bg-opacity-50 text-white px-3 py-1 rounded-full text-sm flex items-center gap-2 pointer-events-none">
      ...
      {showImageModal && displayImages.length > 0 && (
        ...
        >
          <div 
            className="relative max-w-7xl max-h-[95vh] w-full h-full flex items-center justify-center p-4"
            onClick={(e) => e.stopPropagation()}
          >
            {/* 關閉按鈕 */}
            <button
              onClick={() => setShowImageModal(false)}
              className="absolute top-4 right-4 z-10 bg-black/70 text-white rounded-full p-3 hover:bg-black/90 transition-colors"
              aria-label="關閉"
            >
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {displayImages.length > 1 && (
              <>
                <button
                  ...
                  className="absolute left-4 top-1/2 transform -translate-y-1/2 z-10 bg-black/70 text-white rounded-full p-3 hover:bg-black/90 transition-colors"
                  aria-label="上一張"
                >
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 transform -translate-y-1/2 z-10 bg-black/70 text-white rounded-full p-3 hover:bg-black/90 transition-colors"
                  aria-label="下一張"
                >
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
